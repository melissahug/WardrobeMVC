...
namespace WardrobeMVC.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,Name,Color,Season,Occassion,Description,photo")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,Name,Color,Season,Occassion,Description,photo")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
